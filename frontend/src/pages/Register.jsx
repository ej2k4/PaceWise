  ...
  return (
    <div className="w-full max-w-md mx-auto mt-16 p-10 rounded-[2.5rem] bg-white/80 backdrop-blur-2xl shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)] border border-white/60 transition-all duration-500 hover:shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)]">
      ...
      <form onSubmit={handleRegister} className="flex flex-col gap-6">
        <div className="relative group">
          <input 
            ...
            required 
          />
          <label htmlFor="register-name" className="absolute left-5 -top-3 px-1 text-xs font-bold text-sky-600 transition-all peer-placeholder-shown:text-base peer-placeholder-shown:text-slate-400 peer-placeholder-shown:top-4 peer-focus:-top-3 peer-focus:text-xs peer-focus:text-sky-600 before:content-[''] before:absolute before:inset-0 before:bg-gradient-to-b before:from-transparent before:to-transparent before:-z-10 peer-focus:before:from-white peer-focus:before:to-white">
            Your Name
          </label>
        </div>
        ...
        <div className="relative group">
          <input 
            ...
            required 
          />
          <label htmlFor="register-password" className="absolute left-5 -top-3 px-1 text-xs font-bold text-sky-600 transition-all peer-placeholder-shown:text-base peer-placeholder-shown:text-slate-400 peer-placeholder-shown:top-4 peer-focus:-top-3 peer-focus:text-xs peer-focus:text-sky-600 before:content-[''] before:absolute before:inset-0 before:bg-gradient-to-b before:from-transparent before:to-transparent before:-z-10 peer-focus:before:from-white peer-focus:before:to-white">
            Password
          </label>
        </div>
        ...
        <div className="relative group">
          <input 
            ...
            required 
          />
          <label htmlFor="register-age" className="absolute left-5 -top-3 px-1 text-xs font-bold text-sky-600 transition-all peer-placeholder-shown:text-base peer-placeholder-shown:text-slate-400 peer-placeholder-shown:top-4 peer-focus:-top-3 peer-focus:text-xs peer-focus:text-sky-600 before:content-[''] before:absolute before:inset-0 before:bg-gradient-to-b before:from-transparent before:to-transparent before:-z-10 peer-focus:before:from-white peer-focus:before:to-white">
            Age
          </label>
        </div>
        ...
        <button type="submit" className="w-full py-4 mt-2 bg-sky-600 hover:bg-sky-700 text-white font-bold rounded-2xl shadow-xl shadow-sky-600/20 transition-all duration-300 transform hover:-translate-y-1 active:scale-95 flex justify-center items-center gap-2" disabled={loading}>
      ...
      <p className="text-center mt-8 text-sm text-slate-500 font-medium">
        Already have an account? <Link to="/login" className="text-sky-600 font-bold hover:text-sky-700 transition-colors">Log in here</Link>
      </p>
    </div>
  );
}
